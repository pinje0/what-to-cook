const Footer = () => {
  return (
    <footer className="bg-neutral-900 pb-12 pt-24">
        ...
        <div className="w-full border-t border-slate-700 pt-10">
          ...
          <div className="mb-5 flex items-center justify-center">
            ...
            <a
              ...
              target="_blank"
              className="hover-opacity-animation mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-400 text-white hover:border-primary hover:bg-primary"
            >
              <svg
                role="img"
                width="20"
